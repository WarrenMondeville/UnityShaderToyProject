...
float ground;
#define ground_pos vec3(0.0, -0.55, 0.0)
#define ground_color vec3(0.8,0.8,0.8)

float box1;
vec3 box1_pos;
#define box1_dim vec3(0.5, 0.5, 0.5)
#define box1_color vec3(0.1, 0.5, 1.0)

float box2;
#define box2_pos vec3(-2.0, 0.0, 0.0)
#define box2_dim vec3(0.1, 5.5, 3.0)
#define box2_color vec3(1.0, 1.0, 1.0)

float box3;
#define box3_pos vec3(-2.0, 0.0, -2.0)
#define box3_dim vec3(20.5, 10.5, 0.1)
#define box3_color vec3(0.0, 0.0, 0.0)

float box4;
#define box4_pos vec3(5.0, 10., -1.5)
vec3 box4_dim;
#define box4_color vec3(0.6, 0.0, 0.0)

float torus;
vec3 torus_pos;
#define torus_dim vec2(0.7, 0.1)
#define torus_color vec3(0.0, 0.6, 0.0)

float sphere1;
vec3 sphere1_pos;
#define sphere1_radius 0.5
#define sphere1_color vec3(1.0, 0.1, 0.1)

float sphere2;
vec3 sphere2_pos;
#define sphere2_radius 0.5
#define sphere2_color vec3(0.9, 0.1, 1.0)
