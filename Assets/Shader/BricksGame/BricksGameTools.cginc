...
#define txBallPosVel ivec2(0, 0)
#define txPaddlePos ivec2(1, 0)
#define txPoints ivec2(2, 0)
#define txState ivec2(3, 0)
#define txLastHit ivec2(4, 0)
#define txBricks ivec4(0, 1, 13, 12)

#define ballRadius 0.035
#define paddleSize 0.30
#define paddleWidth 0.06
#define paddlePosY -0.90
#define brickW 2.0 / 13.0
#define brickH 1.0 / 15.0

//----------------

#define shadowOffset vec2(-0.03, 0.03)
...
int font[] = int[](0x75557, 0x22222, 0x74717, 0x74747, 0x11574, 0x71747, 0x71757, 0x74444, 0x75757, 0x75747);
int powers[] = int[](1, 10, 100, 1000, 10000);
