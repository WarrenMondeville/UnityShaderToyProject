...
// Created by inigo quilez - iq/2012/2013
...
#define rlight vec3(3.62, 2.99, 0.71)
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
...
#endif
    {
        ...
        // lights
        vec3 lin = 0.0;
        lin += 2.30 * dif * vec3(2.50, 1.80, 1.30) * pow(sha, vec3(1.0, 1.3, 1.6));
