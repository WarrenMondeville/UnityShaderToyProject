...
#define std_gamma vec3(2.2, 2.2, 2.2)
#define planeCol vec3(1.0, 1.2, 1.5)
#define baseRingCol pow(vec3(1.0, 0.65, 0.25), 0.6)
#define sunCol vec3(1.25, 1.0, 1.1) / 1.25
...
vec2 df(vec2 p, float h) {
    vec2 wp = p;
    float rep = 2.0 * round(mix(5.0, 10.0, h));
    rep = 10.0;
